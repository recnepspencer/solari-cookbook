...
use super::replay_recovery_schema::{
    ...
    RecordReplacementVerification, RegisterVerificationEvidence, ReplayBrokenAt,
    ReplayDiscoveredFromExperimentIdentifier, ReplayFailureJson, ReplaySupersedesIdentifier,
};
use super::{
    ...
    pub schema InterfaceCompilerSchema {
        ...
        members: |schema| {
            schema
                ...
                .field(Execution::reference(), ExecutionCapabilityIdentifier::reference())
                .field(Execution::reference(), ExecutionReplayIdentifier::reference())
                .field(Execution::reference(), ExecutionMode::reference())
                .field(Execution::reference(), ExecutionStartMetricsJson::reference())
                ...
                .field(Capability::reference(), CapabilityIdentifier::reference()).field(Capability::reference(), CapabilityRevision::reference()).field(Capability::reference(), CapabilityApplicationIdentifier::reference()).field(Capability::reference(), CapabilityName::reference()).field(Capability::reference(), CapabilityDescription::reference()).field(Capability::reference(), CapabilityInputSchemaJson::reference()).field(Capability::reference(), CapabilityOutputSchemaJson::reference()).field(Capability::reference(), CapabilityPreconditionsJson::reference()).field(Capability::reference(), CapabilityPostconditionsJson::reference()).field(Capability::reference(), CapabilityPublicationJson::reference()).field(Capability::reference(), CapabilityStatus::reference()).field(Capability::reference(), CapabilityActiveReplayIdentifier::reference())
                ...
                .operation(AdmitExecution::reference().definition().no_external_effect().no_aftermath().finish())
                .operation_decision_fact_budget(AdmitExecution::reference(), 3)
                .operation_projection_work_budget(AdmitExecution::reference(), 12)
                .operation_read_field(AdmitExecution::reference(), CapabilityIdentifier::reference())
                .operation_read_field(AdmitExecution::reference(), CapabilityStatus::reference())
                .operation_read_field(AdmitExecution::reference(), CapabilityActiveReplayIdentifier::reference())
                .operation_create(AdmitExecution::reference(), Execution::reference())
                .operation_create(AdmitExecution::reference(), EventJournal::reference())
                .operation_write(AdmitExecution::reference(), ExecutionIdentifier::reference())
                .operation_write(AdmitExecution::reference(), ExecutionLifecycle::reference())
                .operation_write(AdmitExecution::reference(), ExecutionRevision::reference())
                .operation_write(AdmitExecution::reference(), ExecutionSettlementJson::reference())
                .operation_write(AdmitExecution::reference(), ExecutionCapabilityIdentifier::reference())
                .operation_write(AdmitExecution::reference(), ExecutionReplayIdentifier::reference())
                .operation_write(AdmitExecution::reference(), ExecutionMode::reference())
                .operation_write(AdmitExecution::reference(), ExecutionStartMetricsJson::reference())
                .operation_write(AdmitExecution::reference(), EventJournalIdentifier::reference())
                .operation_write(AdmitExecution::reference(), EventJournalRevision::reference())
                .operation_write(AdmitExecution::reference(), EventJournalEventsJson::reference())
                .operation(CompleteExecution::reference().definition().no_external_effect().no_aftermath().finish())
                .operation_decision_fact_budget(CompleteExecution::reference(), 5)
                .operation_projection_work_budget(CompleteExecution::reference(), 14)
                ...
                .operation_read_field(CompleteExecution::reference(), ExecutionStartMetricsJson::reference())
                ...
                .operation_decision_fact_budget(DegradeReplay::reference(), 19)
                ...
                .operation(RegisterVerificationEvidence::reference().definition().no_external_effect().no_aftermath().finish())
                .operation_decision_fact_budget(RegisterVerificationEvidence::reference(), 10)
                .operation_projection_work_budget(RegisterVerificationEvidence::reference(), 28)
                .operation_read_field(RegisterVerificationEvidence::reference(), CapabilityIdentifier::reference()).operation_read_field(RegisterVerificationEvidence::reference(), CapabilityRevision::reference()).operation_read_field(RegisterVerificationEvidence::reference(), CapabilityStatus::reference()).operation_read_field(RegisterVerificationEvidence::reference(), CapabilityActiveReplayIdentifier::reference()).operation_read_field(RegisterVerificationEvidence::reference(), CapabilityCandidateReplayIdentifier::reference())
                .operation_read_field(RegisterVerificationEvidence::reference(), ReplayIdentifier::reference()).operation_read_field(RegisterVerificationEvidence::reference(), ReplayRevision::reference()).operation_read_field(RegisterVerificationEvidence::reference(), ReplayCapabilityIdentifier::reference()).operation_read_field(RegisterVerificationEvidence::reference(), ReplayStatus::reference()).operation_read_field(RegisterVerificationEvidence::reference(), ReplayVerificationJson::reference())
                .operation_write(RegisterVerificationEvidence::reference(), ReplayRevision::reference()).operation_write(RegisterVerificationEvidence::reference(), ReplayVerificationJson::reference())
                .operation(RecordReplacementVerification::reference().definition().no_external_effect().no_aftermath().finish())
                .operation_decision_fact_budget(RecordReplacementVerification::reference(), 17)
                .operation_projection_work_budget(RecordReplacementVerification::reference(), 48)
                .operation_read_field(RecordReplacementVerification::reference(), CapabilityIdentifier::reference()).operation_read_field(RecordReplacementVerification::reference(), CapabilityRevision::reference()).operation_read_field(RecordReplacementVerification::reference(), CapabilityStatus::reference()).operation_read_field(RecordReplacementVerification::reference(), CapabilityActiveReplayIdentifier::reference()).operation_read_field(RecordReplacementVerification::reference(), CapabilityCandidateReplayIdentifier::reference()).operation_read_field(RecordReplacementVerification::reference(), CapabilityBrokenReplayIdentifier::reference()).operation_read_field(RecordReplacementVerification::reference(), CapabilityFailureJson::reference())
                .operation_read_field(RecordReplacementVerification::reference(), ReplayIdentifier::reference()).operation_read_field(RecordReplacementVerification::reference(), ReplayRevision::reference()).operation_read_field(RecordReplacementVerification::reference(), ReplayCapabilityIdentifier::reference()).operation_read_field(RecordReplacementVerification::reference(), ReplayStatus::reference()).operation_read_field(RecordReplacementVerification::reference(), ReplayCreatedAt::reference()).operation_read_field(RecordReplacementVerification::reference(), ReplayVerificationJson::reference()).operation_read_field(RecordReplacementVerification::reference(), ReplayFailureJson::reference()).operation_read_field(RecordReplacementVerification::reference(), ReplayBrokenAt::reference())
                .operation_write(RecordReplacementVerification::reference(), CapabilityRevision::reference()).operation_write(RecordReplacementVerification::reference(), CapabilityStatus::reference()).operation_write(RecordReplacementVerification::reference(), CapabilityCandidateReplayIdentifier::reference()).operation_write(RecordReplacementVerification::reference(), CapabilityBrokenReplayIdentifier::reference()).operation_write(RecordReplacementVerification::reference(), CapabilityFailureJson::reference()).operation_write(RecordReplacementVerification::reference(), ReplayRevision::reference()).operation_write(RecordReplacementVerification::reference(), ReplayStatus::reference()).operation_write(RecordReplacementVerification::reference(), ReplayVerificationJson::reference()).operation_write(RecordReplacementVerification::reference(), ReplayFailureJson::reference()).operation_write(RecordReplacementVerification::reference(), ReplayBrokenAt::reference())
...
worth_query_field!(pub ExecutionCapabilityIdentifier in InterfaceCompilerSchema, Execution, ExecutionFacts: String, read_write, equality);
worth_query_field!(pub ExecutionReplayIdentifier in InterfaceCompilerSchema, Execution, ExecutionFacts: String, read_write, equality);
worth_query_field!(pub ExecutionMode in InterfaceCompilerSchema, Execution, ExecutionFacts: String, read_write, equality);
worth_query_field!(pub ExecutionStartMetricsJson in InterfaceCompilerSchema, Execution, ExecutionFacts: String, read_write, equality);
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct AdmitExecutionInput {
    pub execution_id: String,
}
worth_query_portable_type!(AdmitExecutionInput => "interface-compiler.worth.admit-execution.input.v1");
worth_query_operation!(pub AdmitExecution(AdmitExecutionInput) in InterfaceCompilerSchema);
worth_query_operation_reads!(AdmitExecution => [CapabilityIdentifier, CapabilityStatus, CapabilityActiveReplayIdentifier]);
impl declaration::application_schema::OperationCreates<AdmitExecution> for Execution {}
impl declaration::application_schema::OperationCreates<AdmitExecution> for EventJournal {}
worth_query_operation_writes!(AdmitExecution => [ExecutionIdentifier, ExecutionLifecycle, ExecutionRevision, ExecutionSettlementJson, ExecutionCapabilityIdentifier, ExecutionReplayIdentifier, ExecutionMode, ExecutionStartMetricsJson, EventJournalIdentifier, EventJournalRevision, EventJournalEventsJson]);
#[derive(Clone, Debug, Eq, PartialEq)]
...
worth_query_operation_reads!(CompleteExecution => [ExecutionIdentifier, ExecutionLifecycle, ExecutionRevision, ExecutionSettlementJson, ExecutionStartMetricsJson]);
...
worth_query_field!(pub CapabilityInputSchemaJson in InterfaceCompilerSchema, Capability, CapabilityFacts: String, read_only, equality);
worth_query_field!(pub CapabilityOutputSchemaJson in InterfaceCompilerSchema, Capability, CapabilityFacts: String, read_only, equality);
worth_query_field!(pub CapabilityPreconditionsJson in InterfaceCompilerSchema, Capability, CapabilityFacts: String, read_only, equality);
worth_query_field!(pub CapabilityPostconditionsJson in InterfaceCompilerSchema, Capability, CapabilityFacts: String, read_only, equality);
worth_query_field!(pub CapabilityPublicationJson in InterfaceCompilerSchema, Capability, CapabilityFacts: String, read_only, equality);
...
pub struct ExecutionCapabilitySlot;
pub struct ExecutionReplaySlot;
pub struct ExecutionModeSlot;
pub struct ExecutionStartMetricsSlot;
...
worth_query_portable_type!(ExecutionCapabilitySlot => "interface-compiler.worth.execution-read.capability.v1");
worth_query_portable_type!(ExecutionReplaySlot => "interface-compiler.worth.execution-read.replay.v1");
worth_query_portable_type!(ExecutionModeSlot => "interface-compiler.worth.execution-read.mode.v1");
worth_query_portable_type!(ExecutionStartMetricsSlot => "interface-compiler.worth.execution-read.start-metrics.v1");
    ...
    for InterfaceCompilerExecutionProjection
{
    fn project(
        ...
        Ok(Self {
            ...
            capability_id: row.field(execution_capability_result())?,
            replay_version_id: row.field(execution_replay_result())?,
            mode: row.field(execution_mode_result())?,
            start_metrics_json: row.field(execution_start_metrics_result())?,
            metrics_json: row.field(execution_start_metrics_result())?,
        })
    }
}
...
pub(super) fn execution_capability_result() -> ExecutionResultField<
...
pub(super) fn execution_replay_result() -> ExecutionResultField<
    ExecutionReplaySlot,
...
pub(super) fn execution_mode_result() -> ExecutionResultField<
    ExecutionModeSlot,
    ExecutionMode,
    String,
    declaration::application_schema::ReadWrite,
...
pub(super) fn execution_start_metrics_result() -> ExecutionResultField<
    ExecutionStartMetricsSlot,
    ExecutionStartMetricsJson,
    String,
    declaration::application_schema::ReadWrite,
> {
    declaration::application_query::ApplicationQueryResultFieldRef::new(
