...
interface HostVerificationRun { readonly id: string; readonly capabilityId: string; readonly replayVersionId: string; readonly sessionId: string; readonly outcome: string; readonly evidenceIds: readonly string[]; readonly completedAt: string }
